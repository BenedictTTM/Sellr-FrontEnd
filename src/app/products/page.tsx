...
import CatergorySideBar from '../../Components/Categories/categorySidebar'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        {/* Main Content Area - No left margin, no max-width restrictions */}
        <div className="flex-1 min-w-0">
          {/* Hero Section - Full width of remaining space */}
